      ...
      <section className="py-20">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-14">
            {c.services.map((s, i) => (
              <Link key={i} href={s.href} className="group bg-brand-light rounded-2xl p-6 hover:shadow-lg transition-all hover:-translate-y-1 flex gap-4">
                <div className="w-10 h-10 rounded-xl bg-brand-primary flex-shrink-0 flex items-center justify-center mt-0.5">
                  <svg viewBox="0 0 20 20" className="w-5 h-5 fill-white">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                </div>
                <div>
                  <h3 className="font-bold text-brand-dark mb-2 group-hover:text-brand-primary transition-colors">{s.title}</h3>
          ...
          <div className="text-center">
            <Link href={`/${language}/techniques`} className="inline-flex items-center gap-2 bg-brand-primary text-white font-semibold px-8 py-4 rounded-full hover:bg-brand-primary-hover transition-colors">
              {c.ctaBtn}
