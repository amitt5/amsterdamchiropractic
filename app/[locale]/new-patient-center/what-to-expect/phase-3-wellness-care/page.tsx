        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-6 text-brand-muted">
            ...
            <div className="bg-brand-light rounded-2xl p-6">
              <h3 className="text-brand-dark font-bold text-lg mb-3">{c.benefitsTitle}</h3>
              <ul className="space-y-3">
                {c.benefits.map((item, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <svg viewBox="0 0 20 20" className="w-5 h-5 text-brand-primary flex-shrink-0 mt-0.5 fill-current">
            ...
            <div className="bg-brand-primary/5 border border-brand-primary/20 rounded-2xl p-6">
              <p className="text-brand-muted leading-relaxed italic">{c.quote}</p>
              <p className="text-brand-primary font-semibold mt-3 text-sm">— Dr. M. Jahani</p>
            </div>

            <div className="flex gap-4 mt-8">
              <Link href={`/${language}#booking`} className="bg-brand-primary text-white font-semibold px-6 py-3 rounded-full hover:bg-brand-primary-hover transition-colors text-sm">
                {c.bookBtn}
              </Link>
