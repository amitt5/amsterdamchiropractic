        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-6 text-brand-muted">
            ...
            <div className="bg-brand-light rounded-2xl p-6">
              <h3 className="text-brand-dark font-bold text-lg mb-3">{c.expectTitle}</h3>
            ...
            <div className="flex gap-4 mt-8">
              <Link href={`/${language}/new-patient-center/what-to-expect/phase-3-wellness-care`} className="bg-brand-primary text-white font-semibold px-6 py-3 rounded-full hover:bg-brand-primary-hover transition-colors text-sm">
                {c.nextBtn}
              </Link>
