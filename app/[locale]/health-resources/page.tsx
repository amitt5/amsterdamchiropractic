        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {c.categories.map((category, idx) => (
              <div key={idx} className="bg-brand-light rounded-2xl p-6 hover:shadow-lg transition-shadow">
                ...
                <h3 className="font-bold text-brand-dark text-lg mb-2">{category.title}</h3>
                <p className="text-brand-muted text-sm mb-4 leading-relaxed">{category.description}</p>
          ...
          <div className="mt-16 bg-brand-primary/5 border border-brand-primary/20 rounded-2xl p-8 text-center">
            <h3 className="font-bold text-brand-dark text-xl mb-3">{c.ctaTitle}</h3>
            <p className="text-brand-muted mb-6 max-w-2xl mx-auto">{c.ctaDesc}</p>
