...
export default function PaymentOptionsPage() {
  ...
  const t = {
    en: {
      ...
      ratesPrice: 'Price',
      paymentNote: 'Payment is due after each visit. We accept cash and debit card (pin). Receipts are provided for insurance reimbursement. Please note: for some conditions, treatment costs are case-dependent — we can provide an estimate after your first consultation.',
      ...
      rows: [
        ...
        { label: 'Follow-up Chiropractic Consultation', price: '€85' },
        { label: 'Follow-up Consultation (Chiropractic + Medical Acupuncture)', price: '€130' },
    ...
    nl: {
      ...
      ratesPrice: 'Prijs',
      paymentNote: 'Betaling vindt plaats na elk bezoek. Wij accepteren contant geld en pinpas. Bonnen worden verstrekt voor verzekeringsdeclaraties. Let op: bij sommige aandoeningen zijn de behandelkosten afhankelijk van uw situatie — na het eerste consult kunnen wij u een kosteninschatting geven.',
      ...
      rows: [
        ...
        { label: 'Vervolgconsultatie Chiropractie', price: '€85' },
        { label: 'Vervolgconsultatie (Chiropractie + Medische Acupunctuur)', price: '€130' },
