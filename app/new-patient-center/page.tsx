...
export default function NewPatientCenterPage() {
  ...
  const t = {
    en: {
      ...
      sections: [
        { title: 'Your First Visit', href: '/new-patient-center/your-first-visit', desc: 'A step-by-step overview of what happens during your first appointment — from intake forms to your personalised wellness program.', icon: calendarIcon },
        { title: 'What to Expect', href: '/new-patient-center/what-to-expect', desc: 'Understand the three phases of chiropractic care — Relief, Corrective, and Wellness — and what each phase means for your recovery.', icon: clipboardIcon },
        { title: 'Online Forms', href: '/patient-forms', desc: 'Download and complete your new patient intake forms before your first visit to save time at the clinic.', icon: docIcon },
        { title: 'Health Resources', href: '/health-resources', desc: 'Curated links to chiropractic organisations, wellness resources, and complementary health information.', icon: bookIcon },
        { title: 'Payment Options', href: '/new-patient-center/payment-options', desc: 'Information on insurance coverage, pricing, and flexible payment arrangements for all budgets.', icon: cardIcon },
      ],
    },
    nl: {
      badge: 'Welkom',
      ...
      sections: [
        { title: 'Uw Eerste Bezoek', href: '/new-patient-center/your-first-visit', desc: 'Een stap-voor-stap overzicht van wat er tijdens uw eerste afspraak gebeurt — van het intakeformulier tot uw persoonlijk welzijnsprogramma.', icon: calendarIcon },
        { title: 'Wat te Verwachten', href: '/new-patient-center/what-to-expect', desc: 'Begrijp de drie fasen van chiropractische zorg — Verlichting, Correctie en Welzijn — en wat elke fase betekent voor uw herstel.', icon: clipboardIcon },
        { title: 'Online Formulieren', href: '/patient-forms', desc: 'Download en vul uw patiëntformulieren in vóór uw eerste bezoek om tijd te besparen bij de kliniek.', icon: docIcon },
        { title: 'Gezondheidsinfo', href: '/health-resources', desc: 'Geselecteerde links naar chiropractische organisaties, welzijnsinformatie en aanvullende gezondheidsbronnen.', icon: bookIcon },
        { title: 'Betalingsopties', href: '/new-patient-center/payment-options', desc: 'Informatie over verzekeringsdekking, tarieven en flexibele betalingsregelingen voor elk budget.', icon: cardIcon },
      ],
    },
  };
